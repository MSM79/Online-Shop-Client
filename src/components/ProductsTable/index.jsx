              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr class="border-b dark:border-gray-700">
                    ...
                    >
                      Womens Basic Teeshirt&#34;
                    </th>
                    <td class="px-4 py-3">Women</td>
                    <td class="px-4 py-3">My Way</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">black</td>
                  ...
                  <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">Men</td>
                    <td class="px-4 py-3">Full Nelson</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">black</td>
                    <td class="px-4 py-3">$36</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                      <button
                  ...
                  <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">Men</td>
                    <td class="px-4 py-3">Full Nelson</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Red</td>
                  ...
                  <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">Women</td>
                    <td class="px-4 py-3">My Way</td>
                    <td class="px-4 py-3 max-w-[12rem] truncate">Green</td>
                    <td class="px-4 py-3">$37</td>
                    <td class="px-4 py-3 flex items-center justify-end">
                      <button
